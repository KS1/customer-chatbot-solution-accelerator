...
- Microsoft AI Solution Accelerators: https://accelerators.ms/ 

- Forked from - https://github.com/microsoft/customer-chatbot-solution-accelerator

- Application is deployed. Deployment URLs -
...
### Claude Code Deployment Screenshot

![image](./documents/Images/ClaudeCodeDeployment-Screenshot.png)

### Azure Portal Deployment Screenshot
